                                ...
                                <Flex key={b.id} gap={3} py={3}
                                    ...
                                    <Box flex={1} minW={0}>
                                        ...
                                        <Flex align="center" gap={2} mt={0.5}>
                                            <Text fontSize="10px" color="gray.400" noOfLines={1}>{b?.circuitBooking?.[0]?.circuitDetails?.packagesCircuit?.[0]?.title}</Text>
                                            <Box w="3px" h="3px" borderRadius="full" bg="gray.300" flexShrink={0} />
                                            <Text fontSize="10px" color="gray.400" noOfLines={1}>{b?.circuitBooking?.[0]?.circuitDetails?.packagesCircuit?.[0]?.month + " " + b?.circuitBooking?.[0]?.circuitDetails?.packagesCircuit?.[0]?.year}</Text>
                                            <Box w="3px" h="3px" borderRadius="full" bg="gray.300" flexShrink={0} />
...
export default CircuitsBooking