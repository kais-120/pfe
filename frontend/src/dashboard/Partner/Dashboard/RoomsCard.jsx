...
const RoomsCard = () => {
    ...
    useEffect(() => {
        const dataFetch = async () => {
            try {
                const res = await AxiosToken.get("/dashboard/partner/my-rooms");
    ...
    return (
        <Box bg="white" borderRadius="2xl" border="1px solid" borderColor="gray.100"
            ...
            <Flex px={5} py={3.5} borderTop="1px solid" borderColor="gray.100" gap={2} flexWrap="wrap">
                <Button onClick={()=>navigate("service/hotel/room/add")} size="xs" colorScheme="purple" borderRadius="lg" fontWeight={700}>
                    + Ajouter une chambre
                </Button>
