...
const AgencyCard = () => {
    ...
    useEffect(() => {
        const dataFetch = async () => {
            try {
                const res = await AxiosToken.get("/dashboard/partner/my-offer");
                                                ...
                                                <Flex align="center" gap={2}>
                                                    <Box flex={1} bg="gray.100" borderRadius="full" h="5px" overflow="hidden" maxW="80px">
                                                        <Box h="100%" borderRadius="full"
                                                            bg={offer.status ? "#7C3AED" : "#CBD5E1"}
                                                            style={{ width: `${offer.occupation}%`, transition: "width 0.4s" }} />
                                                    </Box>
                                                    <Text style={{ fontSize: "10px", fontWeight: 700, color: "#64748B" }}>{offer.occupation}%</Text>
                                                </Flex>
                                            </Box>
                                        </Box>
                                    )
